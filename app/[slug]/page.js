...
export async function generateMetadata({ params }) {
  ...
  let post = null
  try {
    const apiUrl = new URL(`/api/content?type=blog&slug=${encodeURIComponent(resolvedParams.slug)}&language=en`, baseUrl)
    ...
    console.warn('Error fetching blog post from content API:', error)
  }
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.sportendorse.com/${resolvedParams.slug}`,
      languages: {
