...
export async function generateMetadata({ params }) {
  ...
  let post = null
  try {
    const apiUrl = new URL(`/api/content?type=blog&slug=${encodeURIComponent(resolvedParams.slug)}&language=es`, baseUrl)
    ...
    console.warn('Error fetching blog post from content API (es):', error)
  }
