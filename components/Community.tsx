      ...
      <div className="statistics-grid">
        <div className="stat-box">
          <div className="stat-content">
            ...
            <p className="stat-number">{athletes.toLocaleString()}</p>
          </div>
        ...
        <div className="stat-box">
          <div className="stat-content">
            ...
            <p className="stat-number">{showAgencies ? agencies : brands}</p>
          </div>
          <hr className="stats-bar"/>
        ...
        <div className="stat-box">
          <div className="stat-content">
            ...
            <p className="stat-number">{sports.toLocaleString()}</p>
          </div>
          <hr className="stats-bar"/>
          <p>{t.labels.sports}</p>
        </div>
        <div className="stat-box">
          <div className="stat-content">
            ...
            <p className="stat-number">{nationalities.toLocaleString()}</p>
          </div>
          <hr className="stats-bar"/>
