        ...
        <div className="footer-top">
          ...
          <div className="footer-links">
            <div>
              ...
              <h5>{/* <span className="footer-number">02]</span> */}<Link target="_blank" href="https://meetings.hubspot.com/alicia269/sport-endorse-demo?embed=true">{t.links.bookDemo}<img src="/images/yellowArrow.svg" alt="yellow arrow svg" width={16} height={16} loading="lazy" sizes="16px" /></Link></h5>
