        ...
        <div className="footer-top">
          ...
          <div className="footer-links">
            <div>
              ...
              <h5>{/* <span className="footer-number">03]</span> */}<Link href={getNavLink("/book-a-demo")}>{t.links.bookDemo}<img src="/images/yellowArrow.svg" alt="yellow arrow svg" width={16} height={16} loading="lazy" sizes="16px" /></Link></h5>
